...
module.exports = (function () {
  ...
  ColorAlpha.prototype.toString = function toString(space) {
    if (space === 'hexa') return '#' + Util.toHex(Util.toHex(this.red()) + Util.toHex(this.green())  + Util.toHex(this.blue() + this.alpha()*255))
    ...
    // CHANGED ES6
    // if (space === 'hexa') return `#${Util.toHex(this.red())}${Util.toHex(this.green())}${Util.toHex(this.blue())}${Util.toHex(this.alpha()*255)}`
    // if (space === 'hsva') return `hsva(${this.hsvHue()}, ${this.hsvSat()}, ${this.hsvVal()}, ${this.alpha()})`
    // if (space === 'hsla') return `hsla(${this.hslHue()}, ${this.hslSat()}, ${this.hslLum()}, ${this.alpha()})`
    //                       return `rgba(${this.red()   }, ${this.green() }, ${this.blue()  }, ${this.alpha()})`
  }
